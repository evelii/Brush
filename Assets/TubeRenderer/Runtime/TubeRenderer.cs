...
{
	public TooManyPointsException() : base() { }
	public TooManyPointsException(string message) : base(message) { }
	public TooManyPointsException(string message, Exception inner) : base(message, inner) { }

	// A constructor is needed for serialization when an
	// exception propagates from a remoting server to the client.
	protected TooManyPointsException(System.Runtime.Serialization.SerializationInfo info,
		...
		set {
			...
			if( value.Length != _points.Length ){
				...
				if( targetVertexCount > meshVertexCountLimit ){
					String message = logPrepend + "Points change for " + name + " was ignored. You are exceeding Unity's 65000 vertex limit.\n";
					//Debug.LogWarning(message);
					throw new TooManyPointsException(message);
					//return;
				}
